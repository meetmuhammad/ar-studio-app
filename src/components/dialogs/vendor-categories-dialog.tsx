 ...
 * nothing references the category. Every endpoint behind this is withAdmin, so
 * this dialog is a convenience, not the access control.
 *
 * Renaming does not touch history. Ledger entries store the category name as it
 * was when they were written, so past reports keep reading the way the books
 * read at the time.
 */
